...
class SideBar(ctk.CTkFrame):
    def __init__(self, root):
        ...
        self.start_test_button = ctk.CTkButton(self, text='📁', command=self.open_source,
                                               font=ctk.CTkFont(size=20, ),
                                               fg_color='#212121', text_color='#858585', width=15, height=10,
                                               anchor='w', hover_color='#474747')
